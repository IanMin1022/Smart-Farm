...
class Main(QWidget):
    ...
    def __init__(self):
        ...
        self.ui.widgets.addWidget(self.cam)
        self.setDisabledStyle(self.ui.cam_button)
        ...
        self.ui.widgets.setCurrentIndex(3)
    ...
    def onPressConnectButton(self, port, isConnect):        
        ...
        if not self.serial._personal_port:
            if isConnect:
                ...
                self.ui.cam_button.clicked.disconnect()
    ...
    def onPaging(self, idx):
        ...
        for i, button in enumerate([self.ui.sen_button,self.ui.act_button, self.ui.cam_button, self.ui.set_button]):
    ...
    def signals(self):
        ...
        self.ui.cam_button.clicked.connect(lambda : self.ui.widgets.setCurrentIndex(2))   
        self.ui.set_button.clicked.connect(lambda : self.ui.widgets.setCurrentIndex(3))        
